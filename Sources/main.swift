import Learn_to_Code
/*
   Learn to Code : Issuing Commands
   ...
   **Goal**: Use Swift commands to tell @ to move and collect a gem.
   ...
   In this first puzzle, you'll need to write Swift commands 
   to move @ across the puzzle world to collect a gem.
